...
int main(int argc, char* argv[])
{
	...
	for(int i = 0; i < 3; i++)
{
    //unstable -300, underdamped -100 ., crit -75 k and -3400d
    KpGain[i] = -300;	//Proportional Gain. Ku: -300 Tu: 0.167s (Recommended -99)
    KiGain[i] = -0;      //Integral Gain (Recommended -0.5)
    KdGain[i] = -0; 	//Derivative Gain (Recommended -3400)
